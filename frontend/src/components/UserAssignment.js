...
const UserAssignment = () => {
  ...
  const handleAssignDivision = async () => {
    ...
    try {
      const response = await fetch(`/api/users/${selectedUser}/assign-division`, {
        method: "POST",
        headers: {
  ...
  const handleRemoveDivision = async (userId, divisionId) => {
    try {
      const response = await fetch(`/api/users/${userId}/remove-division`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleAssignOU = async () => {
    ...
    try {
      const response = await fetch(`/api/users/${selectedUser}/assign-ou`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleRemoveOU = async (userId, ouId) => {
    try {
      const response = await fetch(`/api/users/${userId}/remove-ou`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
